...
chunker agrees, so both are checked.
    ...
    ~/.cache/capture-venv/bin/python tests/test_capture.py
"""
import asyncio
import json
import os
...
os.environ.update(
    ...
    CAPTURE_UPSTREAM="http://127.0.0.1:18000",
    CAPTURE_IDLE_S="0",
...
async def run_all():
    ...
    from proxy import render, sse as ssemod
